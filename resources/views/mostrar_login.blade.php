			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="https://upload.wikimedia.org/wikipedia/commons/1/13/Universidad-nacional-del-callao.png" class="brand_logo" alt="Logo">
					</div>
				</div>
				<div class="d-flex justify-content-center form_container">
					<form action="{{route('login')}}" method="POST">
						@csrf
						<br>
						<h5 class="tituloo" style="color: black;">TRANSPARENCIA UNAC</h5>
					...
					<script>
						function submitForm() {
							document.getElementById('loginForm').action = "{{ route('mostrar_formulario', ['id']) }}";
